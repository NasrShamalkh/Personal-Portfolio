      ...
      <div id='main-div'>
        <div className='aboutDiv'>
          ...
          <div>
            <p>
              ...
              interactive working environment and made problem solving an
              everyday thing.
              <br />
              When I am not coding, I am usually poking around into either one
              of two worlds, <span className='color2'>Movies and TV</span> or
        ...
        <div className='aboutDiv'>
          <div>
            ...
            <ul>
              <li>
                <span className='color2'>-</span> Advanced problem solving
                skills.
              </li>
              <li>
                <span className='color2'>-</span> Handles both front and back
                end development (superpowes in Back end).
              </li>
              <li>
                <span className='color2'>-</span> Constantly developing skills (
                currently learning python & other javascript frameworks).
              </li>
              <li>
            ...
            <a
              href='https://drive.google.com/file/d/1SN3PBYxl2yVGnMVTlOrvL2JOLCxSrEEj/view?usp=sharing'
              target='_blank'
              rel='noopener noreferrer'
            >
            ...
            <ul>
              ...
              <li>
                <img
                  ...
                  src={email}
                ></img>{' '}
                <span> naaaa9sr-@hotmail.com</span>
              </li>
            </ul>
          </div>
          <div id='contact2'>
